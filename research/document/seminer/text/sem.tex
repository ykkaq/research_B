...
\begin{equation}
  ...
  \begin{split}
    ...
    \end{bmatrix}\\
    &=\begin{bmatrix}
      \lambda^{-1}_{N}\partial_{\omega} f_{N} & \lambda^{-1}_{N}\partial_{a_{-N+1}} f_{N}  & \cdots \\
      \lambda^{-1}_{N+1}\partial_{\omega} f_{N+1} & \lambda^{-1}_{N+1}\partial_{a_{-N+1}} f_{N+1}  & \cdots \\
      \vdots & \vdots & \ddots \\
    \end{bmatrix}\\
    &=\begin{bmatrix}
      \lambda^{-1}_{N} 3^{-1}\mu i N (a*a*a)_N & 0 & \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-2} & \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-3} & \cdots & \lambda^{-1}_{N} \mu i N \omega (a*a)_{1} \\
      \lambda^{-1}_{N+1} 3^{-1}\mu i (N+1) (a*a*a)_N & 0 & 0 & \lambda^{-1}_{N+1} \mu i (N+1) \omega (a*a)_{2N-2} & \cdots \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-3}\\
      \vdots & \vdots & \vdots & \vdots & \cdots \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-3}\\
      \lambda^{-1}_{3N-3} 3^{-1}\mu i (3N-3) (a*a*a)_N & 0 & 0 & 0 & \cdots \\
      0 & 0 & 0 & 0 & \cdots \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-3}\\
      \vdots & \vdots & \vdots & \vdots & \cdots & \lambda^{-1}_{N} \mu i N \omega (a*a)_{2N-3}
    \end{bmatrix}
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    ...
    \end{bmatrix}\\
    &=\begin{bmatrix}
      \lambda^{-1}_N \lambda_N & & \mathbf{0} & \\
      \lambda^{-1}_{N+1} (\mu i (N+1) \omega) (a*a)_1 & \lambda^{-1}_{N+1} \lambda_{N+1} \\
      \lambda^{-1}_{N+2} (\mu i (N+2) \omega) (a*a)_2 & \lambda^{-1}_{N+2} (\mu i (N+1) \omega) (a*a)_1 &\lambda^{-1}_{N+2} \lambda_{N+2} \\
      \vdots & \vdots & \vdots & \ddots
    \end{bmatrix}\\
    &=\begin{bmatrix}
      1 & & \mathbf{0} & \\
      \lambda^{-1}_{N+1} (\mu i (N+1) \omega) (a*a)_1 & 1 \\
      \lambda^{-1}_{N+2} (\mu i (N+2) \omega) (a*a)_2 & \lambda^{-1}_{N+2} (\mu i (N+1) \omega) (a*a)_1 & 1 \\
      \vdots & \vdots & \vdots & \ddots
    \end{bmatrix}
  \end{split}
\end{equation}
