...
\begin{equation}
  \begin{split}
    ...
    \begin{bmatrix}
      ...
      0 & \cdots & \cdots  & \cdots\\
      \mu i (-N+1) \omega (a*a)_{-2N+2} & 0 & \cdots & \cdots\\
      \mu i (-N+2) \omega (a*a)_{-2N+3} & \mu i (-N+2) \omega (a*a)_{-2N+2} & 0 & \cdots \\
      \vdots & \vdots & \vdots & \ddots \\
      \mu i (N-1) \omega (a*a)_{-1} & \mu i (N-1) \omega (a*a)_{-2}  & \cdots & \cdots
    \end{bmatrix}\\
    &=
    \begin{bmatrix}
      T^{-1}_{0\ 0} + \sum_{j=0}^{2N-3} T^{-1}_{0\ 2+j} \mu i (-N+1+j) \omega (a*a)_{-2N+2+j} & \cdots \\
      \vdots & \ddots
    \end{bmatrix}
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    ...
    \end{bmatrix}\\
    &=\begin{bmatrix}
      \lambda^{-1}_{N} 3^{-1}\mu i N (a*a*a)_N & 0 & \lambda^{-1}_{N} \mu i N (a*a)_{2N-2} & \lambda^{-1}_{N} \mu i N (a*a)_{2N-3} & \cdots \\
      \lambda^{-1}_{N+1} 3^{-1}\mu i (N+1) (a*a*a)_N & 0 & 0 & \lambda^{-1}_{N+1} \mu i (N+1) (a*a)_{2N-2} & \cdots \\
      \vdots & \vdots & \vdots & \vdots & \cdots \\
      \lambda^{-1}_{3N-3} 3^{-1}\mu i N (a*a*a)_N & 0 & 0 & 0 & \cdots \\
      0 & 0 & 0 & 0 & \cdots \\
      \vdots & \vdots & \vdots & \vdots & \cdots
    \end{bmatrix}
  \end{split}
